...
// this is used as the json object when returning associated hotel data
...
// this is used as the json object when returning associated room data
...
type Room struct {
	...
	RoomNumber       int             `gorm:"type:int;not null;uniqueIndex:idx_hotel_room_number,priority:2" json:"room_number" validate:"required,min=1,max=5"`
